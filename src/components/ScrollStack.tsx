...
const ScrollStack = ({ items, title, subtitle }: ScrollStackProps) => {
  ...
  const activeCardIndex = useTransform(scrollYProgress, [0, 1], [0, items.length - 1])
                ...
                >
                  <motion.div
                    className={`relative bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-500 ${
                      isActive ? 'cursor-pointer hover:shadow-2xl hover:-translate-y-2' : 'pointer-events-none'
                    }`}
                  ...
                  >
                    ...
                    <div className="p-8">
                      <div className="flex items-start justify-between mb-6">
                        ...
                        >
                          {isActive ? "Click to explore" : "Scroll to reveal"}
                        </motion.div>
                      </div>
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-br from-white/80 to-white/60 rounded-2xl"
