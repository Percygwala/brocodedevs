...
import { Mail, Phone, MapPin, Instagram, Facebook, MessageCircle, Globe, Award, Github } from 'lucide-react'
...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { name: 'GitHub', icon: Github, url: 'https://github.com/brocodedevs/brocodedevs_official' },
  ]
